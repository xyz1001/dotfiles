let g:coc_global_extensions=['coc-yank', 'coc-tasks', 'coc-tabnine', 'coc-html', 'coc-lists', 'coc-floaterm', 'coc-diagnostic', 'coc-clang-format-style-options', 'coc-vimlsp', 'coc-sh', 'coc-pyright', 'coc-json', 'coc-go', 'coc-css', 'coc-cmake', 'coc-clangd', 'coc-explorer']
